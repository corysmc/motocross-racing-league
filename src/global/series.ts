export const raceseries: RaceSeries[] = [
  {
    ...
    slug: "mini-motocross",
    description: "Race Series for mini riders Pee Wee up to Supermini!",
    img: "/assets/img/mini-moto.jpg",
    races: [
      {
        date: "2019-05-01",
        name: "Clinic 1",
    ...
    asterisk: "*NON BEGINNER CLASSES"
  },
  /////
  {
    title: "Fast Moto Fridays",
    slug: "fast-moto-fridays",
    img: "/assets/img/fast-moto.jpg",
    description: "Friday Race Series for all skill levels",
    races: [
      {
        date: "2019-04-19",
        name: "Race 1"
    ...
    classes: [
      ...
      {
        name: "RETRO Vintage (1996 and older)",
        race_order: 1
      },
      {
        name: "450 Beginner",
